...
- **Auto-detect generated ROM** — finds the `.sfc` generated by Archipelago Launcher alongside the patch file
- **One-click Enhance & Launch** — applies music + sprite in-place, then launches SNI, Archipelago Launcher, community tracker, and emulator in sequence
...
- Locate the generated `.sfc` ROM in the same folder
- If the ROM hasn't been generated yet, offer to launch Archipelago Launcher for you
...
4. Launch SNI, Archipelago Launcher, community tracker, and emulator
